...
Run logging rules:
- The canonical shell entry point for this workflow is `bin/linux/codex_prompts/streamer_personality/streamer_personality_profile.sh`.
- Save Codex run logs and final-message markdown files to `/mnt/datalake/DataLake/Sun_Data_Analytics/Processed/Logs/codex_prompts/streamer_personality/streamer_personality_profile/`.

Execution guard:
- If you are reading this prompt inside a `codex exec` session that was launched by `bin/linux/codex_prompts/streamer_personality/streamer_personality_profile.sh`, do not invoke `bin/linux/codex_prompts/streamer_personality/streamer_personality_profile.sh` again.
