...
Execution guard:
- If you are reading this prompt inside a `codex exec` session that was launched by `bin/linux/codex_prompts/personality/personality_unique_features.sh`, do not invoke `bin/linux/codex_prompts/personality/personality_unique_features.sh` again.
