...
Execution guard:
- If you are reading this prompt inside a `codex exec` session that was launched by `bin/linux/codex_prompts/personality/personality_open_coding.sh`, do not invoke `bin/linux/codex_prompts/personality/personality_open_coding.sh` again.
