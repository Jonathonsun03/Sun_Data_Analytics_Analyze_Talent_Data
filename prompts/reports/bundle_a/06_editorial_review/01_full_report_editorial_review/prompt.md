# Bundle A Prompt: Full Report Editorial Review

## Section key
`full_report_editorial_review`

## Goal
Review the complete set of generated Bundle A paragraphs and identify where the report still needs editorial smoothing before client delivery.
