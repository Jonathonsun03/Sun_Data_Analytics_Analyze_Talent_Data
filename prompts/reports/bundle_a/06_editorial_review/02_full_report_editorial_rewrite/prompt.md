# Bundle A Prompt: Full Report Editorial Rewrite

## Section key
`full_report_editorial_rewrite`

## Goal
Rewrite the complete set of client-facing Bundle A report paragraphs so they read like one cohesive, professionally edited report while preserving the underlying analytical meaning.
