...
coding_book <- resolve_datalake_path(
  r"(Z:\DataLake\Sun_Data_Analytics\Processed\Talent_Data\Qualitative Codebooks\concept_areas\definitions\monetary_personality\current\personality_qualitative_code_log.csv)"
)
