...
source(tc_repo_path("r_scripts", "lib", "stream_classification", "talent_rules.R"))
source(tc_repo_path("r_scripts", "lib", "stream_classification", "prompt_builder.R"))
source(tc_repo_path("r_scripts", "lib", "duckdb", "db_schema.R"))
