...
dashboard_source("r_scripts", "lib", "duckdb", "db_connect.R")
dashboard_source("r_scripts", "lib", "import_data", "talent_files.R")
dashboard_source("r_scripts", "lib", "import_data", "viewer_activity.R")
...
dashboard_source("r_scripts", "lib", "dashboard", "data", "company.R")
dashboard_source("r_scripts", "lib", "dashboard", "data", "individual_video.R")
dashboard_source("r_scripts", "lib", "dashboard", "data", "viewer_activity.R")
...
dashboard_source("r_scripts", "lib", "dashboard", "metrics", "company.R")
dashboard_source("r_scripts", "lib", "dashboard", "metrics", "individual_video.R")
dashboard_source("r_scripts", "lib", "dashboard", "metrics", "viewer_activity.R")
...
dashboard_source("r_scripts", "lib", "dashboard", "adapters", "individual_video.R")
