...
DEFAULT_PROMPT_FILE="$REPO/prompts/overall_themes/overall_channel_summary.md"
...
LOG_DIR="$LOG_ROOT/overall_themes/overall_channel_summary"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="overall_channel_summary"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/overall_themes/overall_channel_summary.sh [options] [prompt_file]
