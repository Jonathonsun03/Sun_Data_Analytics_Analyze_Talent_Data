...
DEFAULT_PROMPT_FILE="$REPO/prompts/personality/personality_unique_features.md"
...
LOG_DIR="$LOG_ROOT/personality/personality_unique_features"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="personality_unique_features"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/personality/personality_unique_features.sh [options] [prompt_file]
