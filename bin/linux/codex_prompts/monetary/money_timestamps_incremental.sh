...
DEFAULT_PROMPT_FILE="$REPO/prompts/monetary/money_timestamps_incremental.md"
...
LOG_DIR="$LOG_ROOT/monetary/money_timestamps_incremental"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="money_timestamps_incremental"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/monetary/money_timestamps_incremental.sh [options] [prompt_file]
