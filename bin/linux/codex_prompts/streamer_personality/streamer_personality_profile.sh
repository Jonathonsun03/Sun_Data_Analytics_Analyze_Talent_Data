...
DEFAULT_PROMPT_FILE="$REPO/prompts/streamer_personality/streamer_personality_profile.md"
...
LOG_DIR="$LOG_ROOT/streamer_personality/streamer_personality_profile"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="streamer_personality_profile"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/streamer_personality/streamer_personality_profile.sh [options] [prompt_file]
