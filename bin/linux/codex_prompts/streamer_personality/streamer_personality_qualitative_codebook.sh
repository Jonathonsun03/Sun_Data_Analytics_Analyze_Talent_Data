...
DEFAULT_PROMPT_FILE="$REPO/prompts/streamer_personality/streamer_personality_qualitative_codebook.md"
...
LOG_DIR="$LOG_ROOT/streamer_personality/streamer_personality_qualitative_codebook"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="streamer_personality_qualitative_codebook"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/streamer_personality/streamer_personality_qualitative_codebook.sh [options] [prompt_file]
