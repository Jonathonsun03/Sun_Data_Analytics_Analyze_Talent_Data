...
DEFAULT_PROMPT_FILE="$REPO/prompts/streamer_personality/streamer_personality_open_coding.md"
...
LOG_DIR="$LOG_ROOT/streamer_personality/streamer_personality_open_coding"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="streamer_personality_open_coding"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/streamer_personality/streamer_personality_open_coding.sh [options] [prompt_file]
