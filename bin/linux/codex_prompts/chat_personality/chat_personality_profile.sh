...
DEFAULT_PROMPT_FILE="$REPO/prompts/chat_personality/chat_personality_profile.md"
...
LOG_DIR="$LOG_ROOT/chat_personality/chat_personality_profile"
RUN_TS="$(date +%Y-%m-%d_%H-%M-%S)"
RUN_SLUG="chat_personality_profile"
...
usage() {
  cat <<'EOF'
Usage:
  bin/linux/codex_prompts/chat_personality/chat_personality_profile.sh [options] [prompt_file]
